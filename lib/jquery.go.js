...
var getArgs = function(arguments) {
  return _.filter(_.values(arguments), function(arg) {
    return !!arg;
  });
};
...
jQueryInterface.prototype.asyncCall = function() {
  ...
  getPage(function(page) {
    page.evaluate(function(a) {
      var obj = jQuery(a.selector, a.context), retVal = null;
      if (a.args.length > 0) {
...
// Set the go method.
jQueryInterface.prototype.go = function() {
  return go.apply(this, getArgs(arguments));
};
